...
<script type="text/javascript">
    ...
    function setStatus(id, status) {
        ...
        2==status?$('#myform').attr('action', "<?php echo U('delete');?>"):$('#myform').attr('action', "<?php echo U('state');?>" );
        $('#state').val(status);
        $('#myform').submit();
    }
    ...
    /*排序*/
    function setSort() {
        $('#myform').attr('action', "<?php echo U('Resume/pro_sort');?>");
        $('#myform').submit();
    }
</script>
</head>
...
<div class="subnav">
    <div class="content_menu ib_a blue line_x">
        <a class="add fb J_showdialog" href="<?php echo U('add_pro');?>">
            <em>添加实战项目</em>
        </a>
    </div>
</div>
...
<div class="pad_lr_10">
        ...
        <form action="<?php echo U('Doc/index');?>" id="myform">
            ...
            <table width="100%" cellspacing="0">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="http://<?php echo ($vo['pro_web']); ?>" target="_blank" class="link" style="color:#6FC13F" title="点击跳转"><?php echo ($vo['pro_web']); ?></a>
                        </td>
                        <td>
                            <?php echo ($vo['pro_jia']); ?>
                        </td>
 ...
 if($vo['is_mobile']==1){ echo "是"; }elseif($vo['is_mobile']==2){ echo "否"; }elseif($vo['is_mobile']==3){ echo "自适应"; } ?>
                        ...
                        <td align="center">
                            ...
                            <a href="<?php echo U('Resume/add_pro',array('id'=>$vo['id']));?>" title="点击修改">修改</a>
                            |
                            <a href="<?php echo U('Resume/delete',array('id'=>$vo['id']));?>" title="点击删除" onclick="javascript:return confirm('确定删除吗？');">删除</a>
                        </td>
