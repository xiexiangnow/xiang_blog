                   ...
                   <!--图片列表-->
                    <?php if($doc_list != null): ?><div class="entry-meta">
                        <div class="row">
                          ...
                          <?php if(is_array($doc_list)): $i = 0; $__LIST__ = $doc_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-6 col-md-4">
                              <div class="thumbnail">
                                <img src="<?php echo ($vo['coverimg']); ?>" alt="...">
                                <div class="caption">
                                  <h4><?php echo ($vo['title']); ?></h4>
                                  <!--<p><?php echo ($vo['description']); ?></p>-->
                                  <p style="font-size:12px;">浏览量：<?php echo ($vo['view']); ?></p>
                                  <p> <a href="<?php echo U('show',array('id'=>$vo['id']));?>" class="btn btn-default btn-xs" role="button">SHOW</a></p>
                                </div>
                              </div>
