        ...
        <div class="row">
          <div class="main-content-inner col-sm-12 col-md-8 pull-left">
            ...
            <div id="primary" class="content-area">
              ...
              <article id="post-5"
                class="post-5 post type-post status-publish format-aside hentry category-informal-essay post_format-post-format-aside">
                <div class="blog-item-wrap">
                  <a href="" title="Hello"> </a>
                  <div class="post-inner-content">
                    <header class="entry-header page-header">
                      <h3 class="entry-title">
                        <a href="" rel="bookmark"><span class="glyphicon glyphicon-triangle-right"></span> <?php echo ($muinfo['title']); ?></a>
                      </h3>

                    <?php if($doc_list != null): ?><div class="entry-meta">
                         <style type="text/css">
                              .panel-body a:hover{color:blue;}    
                         </style>
                            <!--文章列表-->
                            <?php if(is_array($doc_list)): $i = 0; $__LIST__ = $doc_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel panel-default">
                                <div class="panel-body">
                                     <a href="<?php echo U('show',array('id'=>$vo['id']));?>" title="<?php echo ($vo['title']); ?>"><h4><?php echo ($vo['title']); ?></h4></a> 

                                     <span style="float:right;">
                                     <span class=" glyphicon glyphicon-time"></span>
                                      <?php echo date('Y-m-d H:i:s',$vo['time'])?>
                                      | 浏览量：<?php echo ($vo['view']); ?>  | 　<span class="glyphicon glyphicon-tag"></span><span class="label label-default"><?php echo $vo['article_type']?$vo['article_type']:'未填写'?></span>
                                     </span>
                                </div>
                                <div class="panel-footer">
                                <span class="glyphicon glyphicon-paperclip"></span> 
                                <span style="color:#363636;">简介：</span><?php echo $vo['description']?$vo['description']:'暂无介绍';?></div>
                              </div><?php endforeach; endif; else: echo "" ;endif; ?>
                             <!--文章列表-->
                      </div>
                  <?php else: ?>
                    <div style="margin-top:108px;font-size:14px;">
                        <div style="color:#DA4453;text-align:center;">
                             <span class="glyphicon glyphicon-hourglass"></span> 暂无数据，敬请期待...
                        </div>
                        <p style="margin-top:70px;"><span class="glyphicon glyphicon-search"></span> 您可以看看其他相关内容：</p>
                        <ul class="list-group">
                          <?php if(is_array($dian_more_list)): $i = 0; $__LIST__ = $dian_more_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="list-group-item">
                                <span class="badge" title="浏览量" style="cursor: pointer;"><?php echo ($vo['view']); ?></span>
                                <a href="<?php echo U('news/show',array('id'=>$vo['id']));?>" title="<?php echo ($vo['title']); ?>" target="_blank"><?php echo ($vo['title']); ?></a>
                              </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                        <p><span class="glyphicon glyphicon-screenshot"></span> 或者这些栏目：</p>
                         <!--二级栏目-->
                               <ul class="nav nav-pills" style="width:1130px;margin:0 auto;">
                                 <?php if(is_array($snvlist)): $i = 0; $__LIST__ = $snvlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$smu): $mod = ($i % 2 );++$i; if($smu['is_nav'] == 1): ?><!--后台让其显示才显示-->
