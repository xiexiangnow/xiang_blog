    ...
    <div id="content" class="site-content">
      ...
      <!--正文部分-->
              <article id="post-62" class="post-62 post type-post status-publish format-standard hentry category-note tag-nginx tag-php">
                ...
                <h2 class="entry-title "><span class="glyphicon glyphicon-share-alt"></span> <?php echo ($base['title']); ?></h2>
                ...
                <div class="entry-meta">
                  <!--在 “关于我们” 中不需要显示  时间 和浏览量  -->
                    <?php if($muinfo['id'] != 14): ?><span class="posted-on"><i class="fa fa-calendar"></i> <time class="entry-date published" datetime="2015-07-04T21:09:56+00:00"><span class="glyphicon glyphicon-time"></span> <?php echo date('Y-m-d H:i:s',$base['time'])?></time>
                     </span>

                      <span class="cat-links"><i class="fa fa-folder-open-o"></i>
                          <span class="glyphicon glyphicon-eye-open"></span> 浏览量：<?php echo ($base['view']); ?>
                      </span><?php endif; ?>
                ...
                <footer class="entry-meta">
                      ...
                      <div class="tagcloud">
                          ...
                          <a href=""><?php echo ($muinfo['title']); ?></a> <a href="">php</a> 
                      </div>
                      <!-- end tags -->
            ...
            <div class="aboutFoot">
                     <?php if(!empty($pre)): ?><span class="previous" style="float:left;">上一篇：<a href="<?php echo U('show/'.$pre['id']);?>" title="<?php echo ($pre['title']); ?>"><?php echo subs($pre['title'],20);?></a></span><?php endif; ?>
                      <?php if(!empty($next)): ?><span class="next" style="float:right;">下一篇：<a href="<?php echo U('show/'.$next['id']);?>"  title="<?php echo ($next['title']); ?>"><?php echo subs($next['title'],20);?></a></span><?php endif; ?>
                  </div>
