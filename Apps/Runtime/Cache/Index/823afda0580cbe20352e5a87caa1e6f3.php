...
.timeline { background: #e0e0e0;border-radius: 10px; }
            ...
            <div id="primary" class="content-area">
              ...
              <ul class="timeline">
                  ...
                  <!--  <li><div class="tldate">2015</div></li> -->
                      ...
                      <?php if(is_array($talk_list)): $k = 0; $__LIST__ = $talk_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k%2==1): ?><li>
                            <div class="tl-circ"></div>
                            <div class="timeline-panel">
                              <div class="tl-heading">
                                <h4><?php echo ($vo['title']); ?></h4>
                                <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i><?php echo date('Y-m-d H:i:s',$vo['time']);?></small></p>
                              </div>
                              <div class="tl-body">
                                <p><?php echo ($vo['content']); ?></p>
                                   <?php if($vo['imgurl'] != null): ?><p align="center"><img src="/Uploads<?php echo ($vo['imgurl']); ?>" alt="lorem pixel"></p><?php endif; ?>
                              </div>
                            </div>
                          </li>
